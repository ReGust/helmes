...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 21, 2021 at 11:19 AM
...
--
-- Table structure for table `sc_sectors`
--

DROP TABLE IF EXISTS `sc_sectors`;
CREATE TABLE IF NOT EXISTS `sc_sectors` (
...
--
-- Dumping data for table `sc_sectors`
--

INSERT INTO `sc_sectors` (`id_sector`, `name`, `parent`) VALUES
(1, 'Manufacturing', 0),
...
--
-- Table structure for table `sc_user_data`
--

DROP TABLE IF EXISTS `sc_user_data`;
CREATE TABLE IF NOT EXISTS `sc_user_data` (
...
--
-- Dumping data for table `sc_user_data`
--

INSERT INTO `sc_user_data` (`id`, `name`, `sectors`, `terms`) VALUES
(11, 'Renee', ' 581, 576, 121, 122', 1);
COMMIT;
